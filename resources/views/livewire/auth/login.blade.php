...
<div class="flex flex-col gap-6 animate-fadeIn">
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <div class="relative">
            ...
            @if (Route::has('password.request'))
                <flux:link class="absolute end-0 top-0 text-sm text-orange-600 hover:text-orange-700 dark:text-orange-400 dark:hover:text-orange-300 transition-colors" :href="route('password.request')" wire:navigate>
        ...
        <!-- Remember Me -->
        <flux:checkbox wire:model="remember" :label="__('Remember me')" class="text-orange-600 dark:text-orange-400" />
    ...
    @if (Route::has('register'))
        <div class="space-x-1 rtl:space-x-reverse text-center text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <flux:link :href="route('register')" wire:navigate class="text-orange-600 hover:text-orange-700 dark:text-orange-400 dark:hover:text-orange-300 font-medium transition-colors">
                {{ __('Sign up') }}
            </flux:link>
        </div>
    @endif

    <!-- Security Badge - Adding trust element -->
