            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('favorites.index') }}" class="ml-1 text-gray-500 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors duration-200 md:ml-2" wire:navigate>Favorites</a>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            @foreach($favorites as $favorite)
                <div wire:key="favorite-{{ $favorite->book->id }}" class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden flex flex-col h-full">
                    ...
                    <div class="p-4 flex-grow flex flex-col">
                        ...
                        <div class="mt-auto pt-4 flex flex-col items-center justify-between">
                            <span class="text-lg font-semibold text-gray-900 dark:text-white mb-3">
