            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    <div class="flex items-center mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-orange-600 dark:text-orange-500 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <span class="text-xl font-bold text-gray-900 dark:text-white">Boma Books</span>
                    </div>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Your premier destination for quality books with a vast selection across all genres.</p>
                    <div class="flex space-x-4">
                        <a href="#" class="text-gray-500 hover:text-orange-600 dark:text-gray-400 dark:hover:text-orange-500">
                ...
                <!-- Contact Info -->
                <div>
                    <h3 class="text-sm font-semibold text-gray-500 uppercase tracking-wider dark:text-gray-400">Contact Us</h3>
                    <ul class="mt-4 space-y-2">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-600 dark:text-gray-400">123 Bookstore Lane<br>Reading, CA 90210</span>
                        </li>
                        ...
                        <li class="flex items-center">
                            ...
                            <span class="text-gray-600 dark:text-gray-400">info@bomabooks.com</span>
                        </li>
                    </ul>
                </div>
            </div>
